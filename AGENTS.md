...
## After Implementing the User Intent
- Update the `IMPLEMENTATION.md` file to reflect the changes made. But only write the necessary information. Because that file will be use for context understanding in the future.
- Do not write unnecessary information or code snippets.
